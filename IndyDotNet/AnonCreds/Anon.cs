...
using static IndyDotNet.AnonCreds.NativeMethods;
...
namespace IndyDotNet.AnonCreds
{
    ...
    /// </summary>
    internal class CredentialSearch : IDisposable
    {
        /// <summary>
        /// Gets the handle.
        /// </summary>
        ...
        /// This field is <c>null</c> when search was created using <see cref="AnonCreds.ProverSearchCredentialsForProofRequestAsync(IWallet, string, string)"/>
        /// </summary>
        ...
        /// Required only when search was opened using <see cref="AnonCreds.ProverSearchCredentialsForProofRequestAsync(IWallet, string, string)"/>
        /// </param>
        public Task<string> NextAsync(int count, string itemReferent = null)
        {
            if (ProofRequest)
            {
                return AnonCredsAsync.ProverFetchCredentialsForProofRequestAsync(this, itemReferent, count);
            }
            return AnonCredsAsync.ProverFetchCredentialsAsync(this, count);
        }
    ...
    /// </summary>
    internal class IssuerCreateSchemaResult
    {
        /// <summary>
    ...
    /// </summary>
    internal class IssuerCreateAndStoreCredentialDefResult
    {
        /// <summary>
    ...
    /// </summary>
    internal class IssuerCreateAndStoreRevocRegResult
    {
        /// <summary>
    ...
    /// </summary>
    internal sealed class IssuerCreateCredentialResult
    {
        /// <summary>
    ...
    /// </summary>
    internal class ProverCreateCredentialRequestResult
    {
        /// <summary>
    ...
    internal static class AnonCredsAsync
    {
        /// <summary>
        ...
        public static Task<IssuerCreateAndStoreRevocRegResult> IssuerCreateAndStoreRevocRegAsync(IWallet wallet, string issuerDid, string type, string tag, string credDefId, string configJson, IBlobStorageWriter tailsWriter)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> IssuerCreateCredentialOfferAsync(IWallet wallet, string credDefId)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(credDefId, "credDefId");
        ...
        public static Task<IssuerCreateCredentialResult> IssuerCreateCredentialAsync(IWallet wallet, string credOfferJson, string credReqJson, string credValuesJson, string revRegId, IBlobStorageReader blobStorageReader)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> IssuerRevokeCredentialAsync(IWallet wallet, IBlobStorageReader blobStorageReader, string revRegId, string credRevocId)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> ProverCreateMasterSecretAsync(IWallet wallet, string masterSecretId)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> ProverGetCredentialAsync(IWallet wallet, string credentialId)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> ProverGetCredentialsAsync(IWallet wallet, string filterJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        /// </param>
        public static Task<CredentialSearch> ProverSearchCredentialsAsync(IWallet wallet, string queryJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> ProverGetCredentialsForProofReqAsync(IWallet wallet, string proofRequestJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<CredentialSearch> ProverSearchCredentialsForProofRequestAsync(IWallet wallet, string proofRequestJson, string extraQueryJson = "{}")
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(proofRequestJson, "proofRequestJson");
        ...
        ///         },
        ///     }.</param>
        public static Task<string> ProverCreateProofAsync(IWallet wallet, string proofRequest, string requestedCredentials, string masterSecret, string schemas, string credentialDefs, string revStates)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<string> CreateRevocationStateAsync(IBlobStorageReader blobStorageReader, string revRegDef, string revRegDelta, long timestamp, string credRevId)
        {
        ...
        /// <param name="timestamp">time represented as a total number of seconds from Unix Epoch.</param>
        /// <param name="credRevId">user credential revocation id in revocation registry.</param>
        public static Task<string> UpdateRevocationStateAsync(IBlobStorageReader blobStorageReader, string revState, string revRegDef, string revRegDelta, long timestamp, string credRevId)
        {
