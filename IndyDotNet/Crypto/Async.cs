...
using static IndyDotNet.Crypto.NativeMethods;
...
namespace IndyDotNet.Crypto
{
    ...
    /// Auth decrypt result.
    /// </summary>
    internal class AuthDecryptResult
    {
        /// <summary>
    ...
    internal sealed class CryptoAsync
    {
        /// <summary>
        ...
        public static Task<string> CreateKeyAsync(IWallet wallet, string keyJson)
        {
        ...
        public static Task<string> GetKeyMetadataAsync(IWallet wallet, string verKey)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(verKey, "verKey");
        ...
        public static Task<byte[]> SignAsync(IWallet wallet, string myVk, byte[] message)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task<AuthDecryptResult> AuthDecryptAsync(IWallet wallet, string myVk, byte[] message)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(myVk, "myVk");
            ParamGuard.NotNull(message, "message");
        ...
        public static Task<byte[]> AnonDecryptAsync(IWallet wallet, string myVk, byte[] encryptedMessage)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(myVk, "myVk");
        ...
        /// </code>
        /// </returns>
        public static Task<byte[]> PackMessageAsync(IWallet wallet, string recipientVk, string senderVk, byte[] message)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        /// </code>
        /// </returns>
        public static Task<byte[]> UnpackMessageAsync(IWallet wallet, byte[] message)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNull(message, "message");
