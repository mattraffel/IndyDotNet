...
using static IndyDotNet.Did.NativeMethods;
...
namespace IndyDotNet.Did
{
    ...
    /// </summary>
    internal static class DidAsync
    {
        /// <summary>
        ...
        public static Task<CreateAndStoreMyDidResult> CreateAndStoreMyDidAsync(IWallet wallet, string didJson)
        {
        ...
        public static Task<string> ReplaceKeysStartAsync(IWallet wallet, string did, string identityJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        public static Task ReplaceKeysApplyAsync(IWallet wallet, string did)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(did, "did");
        ...
        /// <returns>An asynchronous <see cref="Task"/> that  with no return value the completes when the operation completes.</returns>
        public static Task StoreTheirDidAsync(IWallet wallet, string identityJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(identityJson, "identityJson");
        ...
        public static Task<string> KeyForDidAsync(IPool pool, IWallet wallet, string did)
        {
        ...
        /// <returns>An asynchronous <see cref="Task"/> that completes when the operation completes.</returns>
        /// <exception cref="IWalletItemNotFoundException">Thrown if the <paramref name="wallet"/> does not contain the specified <paramref name="did"/>.</exception>
        ...
        public static Task SetDidMetadataAsync(IWallet wallet, string did, string metadata)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(did, "did");
        ...
        /// <exception cref="IWalletItemNotFoundException">Thrown if the wallet does not contain the specified <paramref name="did"/> or the DID did not have any metadata.</exception>
        ...
        public static Task<string> GetDidMetadataAsync(IWallet wallet, string did)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNullOrWhiteSpace(did, "did");
        ...
        /// <param name="wallet">IWallet.</param>
        public static Task<string> ListMyDidsWithMetaAsync(IWallet wallet)
        {
            ParamGuard.NotNull(wallet, "wallet");
