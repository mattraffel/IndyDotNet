...
using static IndyDotNet.Payments.NativeMethods;

namespace IndyDotNet.Payments
{
    /// <summary>
    /// This region will go away as payment api is restructured to fit IndyDotNet patterns
    /// It is here for now to keep project compiling
    /// </summary>
    ...
    /// Payments API
    /// </summary>
    internal static class PaymentsAsync
    {
#if __IOS__
        ...
        /// </code>
        /// </param>
        public static Task<string> CreatePaymentAddressAsync(IWallet wallet, string paymentMethod, string config)
        {
        ...
        /// <param name="wallet">Wallet.</param>
        public static Task<string> ListPaymentAddressesAsync(IWallet wallet)
        {
            ParamGuard.NotNull(wallet, "wallet");
        ...
        ///   }]</param>
        /// <param name="extra">Optional information for payment operation</param>
        public static Task<PaymentResult> BuildPaymentRequestAsync(IWallet wallet, IDid submitterDid, string inputsJson, string outputsJson, string extra)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNull(submitterDid, "submitterDid");
        ...
        ///   txnTypeN: amountN,
        /// }</param>
        public static Task<string> BuildSetTxnFeesRequestAsync(IWallet wallet, IDid submitterDid, string paymentMethod, string feesJson)
        {
            ParamGuard.NotNull(wallet, "wallet");
            ParamGuard.NotNull(submitterDid, "submitterDid");
            ParamGuard.NotNullOrWhiteSpace(paymentMethod, "paymentMethod");
